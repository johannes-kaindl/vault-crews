...
export const EN: Record<string, string> = {
  ...
  "settings.connection.apiKey.placeholder": "API key (optional)",
  "settings.connection.model.placeholder": "Model id",
  "settings.connection.aria.url": "Endpoint URL",
  "settings.connection.aria.add": "Add endpoint URL",
  "settings.connection.aria.apiKey": "API key for {0}",
  "settings.connection.aria.model": "Model for {0}",
  "settings.connection.model.unset": "— no model chosen —",
  "settings.connection.model.hint.unreachable": "Endpoint unreachable — showing the last known value.",
  "settings.connection.model.hint.noList": "This endpoint does not report a model list — type the model id.",
  "settings.connection.model.saved": "(saved)",
  "settings.connection.model.refresh": "Refresh model list",
  "settings.connection.moveToFront": "Use first",
  "settings.connection.thirdParty": "This endpoint has an API key — requests leave your machine.",
  "settings.connection.probing": "Testing…",
  "settings.connection.role.active": "Active",
  "settings.connection.role.unreachable": "Unreachable",
  "settings.connection.role.modelMismatch": "Reachable, but skipped (model mismatch)",
  "settings.connection.role.standby": "Standby — position {0}",
  "settings.connection.source.managed": "Endpoints come from the LLM Endpoint Manager",
  "settings.connection.source.managedDesc": "This plugin uses the endpoints configured in the LLM Endpoint Manager plugin. Your local list stays as a fallback.",
  "settings.connection.source.openManager": "Open manager settings",
  "settings.connection.source.pickEndpoint": "Endpoint",
  "settings.connection.source.automatic": "automatic (first reachable)",
  "settings.connection.source.model": "Model",
  "settings.connection.source.importLocal": "Copy local endpoints into the manager",
  "settings.connection.source.imported": "Copied: {0} new, {1} merged.",
  "settings.connection.source.importFailed": "Copying failed.",
  "settings.connection.saveFailed": "Could not save — check the console.",
  "settings.connection.capabilities.thinking.confirmed": "Reasoning: confirmed by the endpoint",
  "settings.connection.capabilities.thinking.likely": "Reasoning: likely (guessed from the name)",
  "settings.connection.capabilities.thinking.no": "Reasoning: not supported",
  "settings.connection.capabilities.vision.confirmed": "Images: confirmed by the endpoint",
  "settings.connection.capabilities.vision.likely": "Images: likely (guessed from the name)",
  ...
  "notice.errorKind.output_truncated": "The answer ran into the token limit and was cut off — raise max_tokens in the agent note.",
  ...
  "panel.undo": "Undo",
  "panel.status.emptyCollector": "0 matching notes in {0}",
  ...
  "panel.idle.stray": "{0} file(s) with a crew-kind: field sit directly in the crew folder. Crews are only picked up from teams/ and agents/.",
  "panel.idle.problem": "This crew has a problem and will likely fail: {0}",
...
export const DE: Record<string, string> = {
  ...
  "settings.connection.apiKey.placeholder": "API-Schlüssel (optional)",
  "settings.connection.model.placeholder": "Modell-Id",
  "settings.connection.aria.url": "Endpunkt-URL",
  "settings.connection.aria.add": "Endpunkt-URL hinzufügen",
  "settings.connection.aria.apiKey": "API-Schlüssel für {0}",
  "settings.connection.aria.model": "Modell für {0}",
  "settings.connection.model.unset": "— kein Modell gewählt —",
  "settings.connection.model.hint.unreachable": "Endpunkt nicht erreichbar — zuletzt bekannter Wert.",
  "settings.connection.model.hint.noList": "Dieser Endpunkt meldet keine Modell-Liste — Modell-Id eintragen.",
  "settings.connection.model.saved": "(gespeichert)",
  "settings.connection.model.refresh": "Modell-Liste neu laden",
  "settings.connection.moveToFront": "Zuerst verwenden",
  "settings.connection.thirdParty": "Dieser Endpunkt hat einen API-Schlüssel — Anfragen verlassen deinen Rechner.",
  "settings.connection.probing": "Wird geprüft …",
  "settings.connection.role.active": "Aktiv",
  "settings.connection.role.unreachable": "Nicht erreichbar",
  "settings.connection.role.modelMismatch": "Erreichbar, aber übersprungen (Modell passt nicht)",
  "settings.connection.role.standby": "Bereitschaft — Platz {0}",
  "settings.connection.source.managed": "Endpunkte kommen vom LLM Endpoint Manager",
  "settings.connection.source.managedDesc": "Dieses Plugin nutzt die Endpunkte aus dem Plugin LLM Endpoint Manager. Die lokale Liste bleibt als Rückfall erhalten.",
  "settings.connection.source.openManager": "Manager-Einstellungen öffnen",
  "settings.connection.source.pickEndpoint": "Endpunkt",
  "settings.connection.source.automatic": "automatisch (erster erreichbarer)",
  "settings.connection.source.model": "Modell",
  "settings.connection.source.importLocal": "Lokale Endpunkte in den Manager übernehmen",
  "settings.connection.source.imported": "Übernommen: {0} neu, {1} zusammengeführt.",
  "settings.connection.source.importFailed": "Übernahme fehlgeschlagen.",
  "settings.connection.saveFailed": "Konnte nicht speichern — siehe Konsole.",
  "settings.connection.capabilities.thinking.confirmed": "Reasoning: vom Endpunkt bestätigt",
  "settings.connection.capabilities.thinking.likely": "Reasoning: wahrscheinlich (aus dem Namen geraten)",
  "settings.connection.capabilities.thinking.no": "Reasoning: nicht unterstützt",
  "settings.connection.capabilities.vision.confirmed": "Bilder: vom Endpunkt bestätigt",
  "settings.connection.capabilities.vision.likely": "Bilder: wahrscheinlich (aus dem Namen geraten)",
  ...
  "notice.errorKind.output_truncated": "Die Antwort lief ins Token-Limit und wurde abgeschnitten — max_tokens in der Agenten-Notiz erhöhen.",
  ...
  "panel.status.emptyCollector": "0 passende Notizen in {0}",
  ...
  "panel.idle.stray": "{0} Datei(en) mit einem crew-kind:-Feld liegen direkt im Crew-Ordner. Crews werden nur aus teams/ und agents/ gelesen.",
  "panel.idle.problem": "Diese Crew hat ein Problem und wird vermutlich scheitern: {0}",
